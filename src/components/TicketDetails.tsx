...
export default function TicketDetails() {
    ...
    const { currentTicket: ticket, getTicketById, updateTicketStatus, loading, error } = useTicketsStore()
    ...
    // keep local status in sync with the store ticket when it changes
    useEffect(() => {
            ...
            <header className="ticket-details-header">
                ...
                <div className="ticket-status-dropdown">
                    ...
                    <button
                        ...
                        onClick={() => handleUpdateTicketStatus(ticket.id)}
                    >
                        {t('update')}
                    </button>
                </div>
